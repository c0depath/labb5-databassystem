...
CREATE TABLE ÖVERFÖRING(
	...
	CONSTRAINT ÖVERFÖRING_FRÅN_KNR_FK FOREIGN KEY (FRÅN_KNR) REFERENCES KONTO(KNR),
    CONSTRAINT ÖVERFÖRING_TILL_KNR_FK FOREIGN KEY (TILL_KNR) REFERENCES KONTO(KNR)
);
...
THEN 
RAISE_APPLICATION_ERROR(-20001, 'Ditt saldo är lågt för detta uttaget');
END IF;
END;
...
IF P_BELOPP < 0 THEN
        RAISE_APPLICATION_ERROR(
            -20001,
            'Fel: Belopp får inte vara negativt.'
        );
END IF;
...
BEGIN 
DO_INSÄTTNING('630214-1213', 124, 1200);
END;

BEGIN 
DO_INSÄTTNING('930112-1105', 123, -50);
END;

BEGIN 
DO_INSÄTTNING('930112-1105', 123, 1100);
END;
...
BEGIN 
DO_UTTAG('630214-1213', 124, 1200);
END;

BEGIN 
DO_UTTAG('930112-1105', 123, 1200);
END;

BEGIN 
DO_UTTAG('930112-1105', 123, -100);
END;

BEGIN 
DO_UTTAG('630214-1213', 123, 100);
END;
...
AS 
V_KNR NUMBER(6);
V_TILL_KNR_COUNT NUMBER;
OBEHÖRIG EXCEPTION;
INVALID_TILL_KNR EXCEPTION;
BEGIN
IF P_BELOPP < 0 THEN
        RAISE_APPLICATION_ERROR(
            -20001,
...
END IF;
SELECT COUNT(*) 
INTO V_TILL_KNR_COUNT
FROM KONTO
WHERE KNR = P_TILL_KNR;
IF V_TILL_KNR_COUNT = 0 THEN
RAISE INVALID_TILL_KNR;
END IF;
...
WHEN INVALID_TILL_KNR 
THEN
RAISE_APPLICATION_ERROR(-20011, 'Mottagarkontot finns inte!');
END;
...
BEGIN 
DO_ÖVERFÖRING('630214-1213', 123, 1337, 100);
END;

BEGIN 
DO_ÖVERFÖRING('630214-1213', 123, 5899, 2000);
END;

BEGIN 
DO_ÖVERFÖRING('630214-1213', 123, 5899, -100);
END;
